...
NVDA 只會在組字字串中按方向鍵時報讀「空白」，且輸入時點字顯示器無回饋。

此問題追蹤於：
- https://github.com/nvaccess/nvda/issues/14140（輸入組字時無點字回饋）
- https://github.com/nvaccess/nvda/issues/14152（游標導覽報讀不正確）
